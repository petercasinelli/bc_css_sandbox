...
<script type="text/javascript">
	$(function(){
		$("#skills").autoSuggest("<?php echo base_url();?>student/autosuggest_skills", {startText: "Enter skills here",selectedItemProp: "name", searchObjProps: "name",minChars: 2, matchCase: false});
	});
</script>
<!-- Google Analysitcs -->
<script type="text/javascript">
