...
<html>
<head>
	<title>BC Skills - Boston College Computer Science Society</title>
	<meta http-equiv="content-type" content="text/html; charset=UTF-8">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/autoSuggest.css" type="text/css">
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/global.css" type="text/css">
     <link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/typeahead/typeahead.css" type="text/css">
