...
<body>
	...
	<div id="right-column">
		...
		<div class="item non-user-item">
			...
			<p>The Boston College Computer Science Society is excited to announce our new open source project, BC Skills!</p>
			...
			<p>Are you interested in getting involved? The first step is to <?php echo anchor('register/student', 'register'); ?>. Then, start collaborating on <?php echo anchor("https://github.com/pcas00/bc_css_sandbox", "GitHub", 'target="_blank"'); ?>.
