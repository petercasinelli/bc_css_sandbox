...
<div class="container">
    ...
    <div class="hero-unit" style="padding:10px 20px 20px 20px; margin-top:10px; margin-bottom:15px;">
    ...
    <div class="row">
        ...
        <div class="span6 hero-unit" style="padding:10px 20px 20px 20px;">
            ...
            <p><a class="btn .btn-large" href="#">Register for BCVC &raquo;</a></p>
        </div>
        <div class="span5 hero-unit" style="padding:10px 20px 20px 20px;">
            ...
            <p><a class="btn .btn-large" href="#">Read the Full Testimonial &raquo;</a></p>
        </div>
    </div>
