...
<section>
    ...
    <br />
    <a name="join"></a>
    <h1 style="font-size:24px">How To Join A Team</h1>
    <br />
    <div class="grid">
        <div class="quarter">
    ...
    <div class="grid">
        <div class="quarter">
            <h2 class="circle_number float-left">4</h2>After you have requested to join the team, a notice similar to the one on the right will appear on the team page. Now the team administrator's have to accept your request for you to become a part of the team on BC Skills.
        </div>
